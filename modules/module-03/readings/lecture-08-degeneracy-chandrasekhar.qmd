...
Concept-Throughline:
  ...
  - The Chandrasekhar mass scale is set by $\hbar$, $c$, $G$, and $m_p$, while the exact value depends on composition through the electron fraction $Y_e$
...
E_F
\sim
\frac{(10^{-27})^2 \times (3 \times 10^{29})^{2/3}}{10^{-27}}
$$
