...
Here:
- $P_{\text{gas}}$ is the thermal gas pressure, in $\mathrm{dyn\,cm^{-2}}$
...
For an order-of-magnitude estimate, replace $M(r)$ by the total mass $M$ and $\rho(r)$ by the mean density
$$
...
$$
where:
- $P_{\text{gas}}$ is the thermal gas pressure
...
- $\mu m_p$ is therefore the mean mass per particle
