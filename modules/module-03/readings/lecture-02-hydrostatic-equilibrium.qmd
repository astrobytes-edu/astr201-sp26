...
{{< fig radiation-pressure-mass-scaling >}}

At this point, we can partially answer our guiding question. In Sun-like stars, the outward support is supplied mostly by thermal gas pressure. In more massive stars, radiation pressure contributes a much larger share of that support.
...
$$
does not come from a mysterious convention. The short intuition is that thermal support enters through pressure-volume work, while gravitational binding changes with radius in a different way when the whole star is rescaled. In equilibrium, those two scalings differ by a factor of $2$, which is why the thermal term carries that coefficient.

The key takeaway for this course is not the detailed derivation of the coefficient. It is the consequence: the star’s thermal energy is directly tied to its gravitational binding energy.
:::
