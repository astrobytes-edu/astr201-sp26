...
1. If the temperature increased by a factor of 10, would classical fusion become viable?
2. Roughly how hot would the core need to be for $k_B T \sim \mathrm{MeV}$?
...
$$
\frac{\mathrm{erg}}{\mathrm{g}}
=
\frac{\mathrm{g \, cm^2 \, s^{-2}}}{\mathrm{g}}
=
\mathrm{cm^2 \, s^{-2}}.
$$
...
Here $\Delta x$ is the spread in position, $\Delta p$ is the spread in momentum, and $\hbar$ is the reduced Planck constant, which sets the quantum scale.
...
1. What must happen to $\Delta p$?
2. What does that imply about the range of possible velocities?
3. Why does this make a single classical trajectory impossible?
...
<!--
FIGURE SUGGESTION: Wave vs classical particle

Description:
Two-panel diagram:
LEFT: classical particle trajectory stopping at turning point
RIGHT: wavefunction oscillating + decaying into barrier

What to notice:
- classical: sharp boundary
- quantum: smooth exponential decay

Generate with:
- Python (matplotlib)
- plot potential + wavefunction envelope
-->
...
So the correct statement is: the proton does not "hit a wall." Its wavefunction **penetrates** the barrier. That is quantum tunneling.
