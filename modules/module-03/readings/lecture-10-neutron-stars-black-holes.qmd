...
If the embedded player does not appear, open the video directly: [ScienceClic — Neutron Stars and Pulsars](https://youtu.be/oLoLey75i2k?si=4s9p3q6ocvY7XCWQ).
...
If the embedded player does not appear, open the video directly: [ScienceClic — The Math Behind Interstellar's Black Hole](https://youtu.be/ABFGKdKKKyg?si=mawlHH-wcmVcVpR8).
