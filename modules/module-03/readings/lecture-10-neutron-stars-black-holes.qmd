...
m
=
5 \times 10^{14}~\text{g}\,\text{cm}^{-3} \times 5~\text{cm}^3
=
2.5 \times 10^{15}~\text{g}
$$
...
\frac{P_1}{P_2}
=
\left(\frac{7 \times 10^{10}}{10^6}\right)^2
=
4.9 \times 10^9
$$
...
\tau
=
\frac{0.0335}{2 \times 4.21 \times 10^{-13}}
\approx 4.0 \times 10^{10}~\text{s}
$$
...
R_{s,\odot}
=
\frac{2 \times 6.67 \times 10^{-8} \times 2.0 \times 10^{33}}{(3.0 \times 10^{10})^2}
$$

$$
R_{s,\odot}
=
\frac{2.67 \times 10^{26}}{9.0 \times 10^{20}}
\approx 3.0 \times 10^5~\text{cm}
$$
...
\frac{R_s}{R_\odot}
=
\frac{1.2 \times 10^7}{7 \times 10^5}
\approx 17
$$
...
\frac{R_s}{1~\text{AU}}
=
\frac{1.2 \times 10^7}{1.5 \times 10^8}
=
0.08
$$
