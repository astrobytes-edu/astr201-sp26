...
- Calculate orbital velocity and escape velocity
- Use energy and angular momentum to predict orbital behavior
- Explain the virial theorem for bound systems at equilibrium
:::
...
{{< img kepler-first-law >}}

::: {.fragment}
**Key terms:**

- Semi-major axis $a$: average distance
- Eccentricity $e$: how "squashed" (0 = circle, 1 = line)
:::
...
::: {.notes}
Draw attention to the direction changing even as speed stays constant.
:::
...
{{< img conservation-angular-momentum >}}

::: {.notes}
Torque = what makes things spin faster/slower. Central force → no torque → L conserved.
:::
...
For bound systems **in equilibrium** (or averaged over orbits):

$$\langle K \rangle = -\frac{1}{2}\langle U \rangle$$

. . .

**Verify for circular orbit:**

$$K = \frac{GMm}{2r}, \quad U = -\frac{GMm}{r}$$

$$K = -\frac{1}{2}U \quad \checkmark$$

::: {.notes}
The virial theorem connects K and U in any equilibrium gravitational system.
:::
...
| Escape Velocity | $v_{esc} = \sqrt{\dfrac{2GM}{r}}$ |
...
**Next time:** Stellar distances and the cosmic distance ladder

**Before then:**

- Read: Lecture 3 reading (gravity and orbits)
- Review: Unit analysis and scaling methods
