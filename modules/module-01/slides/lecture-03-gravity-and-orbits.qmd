...
| Orbital Vel. | $v_{orb} = \sqrt{\dfrac{GM}{r}}$ |
| Escape Vel. | $v_{esc} = \sqrt{2}\,v_{orb}$ |
...
|----------|----------|
| Total Energy | $E = K + U$ |
| Bound Orbit | $E = -\dfrac{GMm}{2a}$ |
| Ang. Mom. | $L = mvr$ |
| Virial | $\langle K \rangle = -\frac{1}{2}\langle U \rangle$ |
:::
::::
