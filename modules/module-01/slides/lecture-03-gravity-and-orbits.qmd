...
{{< img kepler-second-law width="75%" >}}
...
::: {.incremental}
- Move 2× farther → period ×$2^{3/2} \approx 2.83$
- It's a *proportionality*, not equality
- Constant depends on central mass
:::
:::
...
Mars: $a = 1.52$ AU. Earth: $a = 1$ AU, $P = 1$ yr.

$$\frac{P_{Mars}^2}{P_{Earth}^2} = \frac{a_{Mars}^3}{a_{Earth}^3}$$

$$P_{Mars} = \sqrt{1.52^3} = 1.87\,\text{yr}$$
:::
:::
::::

::: {.notes}
Emphasize: this is empirical—extracted from data. No explanation of *why*. The ratio method avoids needing constants.
:::
...
{{< img newton-ball-on-string width="80%" >}}
