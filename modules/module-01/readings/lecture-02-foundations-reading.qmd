...
::: {.callout-check-yourself}
Light from the Sun takes 8.3 minutes to reach Earth. How far away is the Sun in AU? (This is essentially the definition of 1 AU, so use it as a sanity check.)

*(Think first... then check: Distance = speed × time = $c \times 8.3$ min = $3 \times 10^{10}$ cm/s × 500 s ≈ $1.5 \times 10^{13}$ cm. That's exactly 1 AU. ✓)*
:::
...
1. **Dimensional analysis.** A student proposes that gravitational potential energy is $U = GMmr$. Use dimensional analysis to determine if this could be correct. What should the dimensions of energy be? What does this formula give?

2. **Scaling interpretation.** The Stefan-Boltzmann law says a star's luminosity scales as $L \propto R^2 T^4$. If you double the temperature while keeping the radius constant, by what factor does the luminosity change? What if you double the radius while keeping temperature constant?

3. **Ratio reasoning.** Two stars have the same surface temperature but Star A is 4 times as luminous as Star B. What can you conclude about their relative radii?

### Quick Calculations

4. **Kepler scaling.** Saturn orbits at 9.5 AU. Estimate its orbital period in years.

5. **Black hole size.** A stellar-mass black hole has $M = 10\,M_\odot$. Estimate its Schwarzschild radius in km.

6. **Unit conversion.** Convert Earth's orbital speed of 30 km/s to AU/year. (Hint: 1 AU = $1.5 \times 10^8$ km and 1 year = $3.15 \times 10^7$ s)

7. **OOM estimation.** The Milky Way contains about $10^{11}$ stars. If the average stellar mass is $\sim 0.5\,M_\odot$, estimate the total mass of stars in the galaxy in grams.

### Synthesis

8. **Deriving a new relationship.** Use dimensional analysis to find how the escape velocity $v_\text{esc}$ from a planet scales with the planet's mass $M$ and radius $R$. (Ingredients: $G$, $M$, $R$. Target: velocity $[LT^{-1}]$.)

9. **Applying the toolkit.** You observe two stars of the same spectral type (same temperature). Star A appears 16 times brighter than Star B.
   - (a) What is the ratio of their distances?
   - (b) If Star A is at 10 pc, how far away is Star B?

10. **Black hole comparison.** The black hole at the center of M87 has mass $\approx 6.5 \times 10^9\,M_\odot$.
    - (a) Estimate its Schwarzschild radius in km.
    - (b) Compare this to the size of our solar system (Pluto's orbit ≈ 40 AU).

::: {.callout-note title="Answers" collapse="true"}
**1.** Energy has dimensions $[ML^2T^{-2}]$. The formula gives $[GM][m][r] = [M^{-1}L^3T^{-2}][M][M][L] = [ML^4T^{-2}]$. Wrong! (The correct formula is $U = -GMm/r$.)

**2.** Doubling $T$: $L$ increases by $2^4 = 16$. Doubling $R$: $L$ increases by $2^2 = 4$.

**3.** Since $L \propto R^2$ (at constant $T$), if $L_A = 4L_B$, then $R_A = 2R_B$. Star A has twice the radius.

**4.** $P^2 = 9.5^3 \approx 857$, so $P \approx 29$ years. (Actual: 29.5 years)

**5.** $R_s \approx 3\,\text{km} \times 10 = 30$ km.

**6.** $30\,\text{km/s} = 30 \times (3.15 \times 10^7\,\text{s/yr}) / (1.5 \times 10^8\,\text{km/AU}) \approx 6.3$ AU/yr. (Exact: $2\pi$ AU/yr ≈ 6.28)

**7.** $10^{11} \times 0.5 \times 2 \times 10^{33}\,\text{g} = 10^{44}$ g.

**8.** $v_\text{esc} \propto G^a M^b R^c$ with target $[LT^{-1}]$. Solving: $v_\text{esc} \propto \sqrt{GM/R}$.

**9.** (a) Flux $\propto 1/d^2$, so $d_B/d_A = \sqrt{16} = 4$. (b) $d_B = 4 \times 10 = 40$ pc.

**10.** (a) $R_s \approx 3\,\text{km} \times 6.5 \times 10^9 \approx 2 \times 10^{10}$ km ≈ $1.3 \times 10^{11}$ km = 130 AU. (b) That's about 3× Pluto's orbital radius—the event horizon would swallow much of our solar system!
:::
