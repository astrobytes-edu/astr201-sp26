...
At 1.3 pc, Proxima is ~25 trillion miles away — yet it's the *closest* star.
...
- Sirius: 2.6 pc
- Within 5 pc: only ~60 known stellar systems
:::
...
|---------|-----------|-------|----------------|
| **Ground** (pre-1990) | $\sim 50$ mas | ~1,000 | ~20 pc |
| **Hipparcos** (1989–93) | ~1 mas | ~100,000 | ~100 pc |
| **[Gaia](https://www.esa.int/Science_Exploration/Space_Science/Gaia)** (2013–25) | ~10 $\mu$as | ~1.8 billion | ~10 kpc |
...
**(d)** Estimate the parallax of a star at the center of the Milky Way (~8 kpc away).
:::
...
::: {.fragment .mt-2}
**Answers:** (a) $d = 1/0.050 = 20$ pc. (b) $20 \times 3.26 = 65$ ly. (c) Yes (Hipparcos limit ~1 mas = 0.001'', this is much larger). (d) $p = 1/8000 = 0.000125'' = 125\,\mu$as — detectable by Gaia.
:::
...
10% parallax error → ~10% distance error → ~**20% luminosity error**
:::
...
4. What kind of star? (Very faint red dwarf — ~30,000× dimmer than the Sun!)
:::
:::
...
::: {.incremental}
- ~100 pc from ground-based telescopes
- ~10 kpc with Gaia
:::

::: {.fragment .mt-2}
But the Milky Way is ~30 kpc across, and Andromeda is ~770 kpc away.
