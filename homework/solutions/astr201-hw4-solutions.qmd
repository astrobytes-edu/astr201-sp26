...
$$
\frac{F_{\text{Bet}}}{F_\odot}
= \left(\frac{T_{\text{Bet}}}{T_\odot}\right)^4
= \left(\frac{3{,}500~\text{K}}{5{,}800~\text{K}}\right)^4
= (0.603)^4
= 0.133\frac{\text{K}^4}{\text{K}^4}
= 0.133.
$$
...
= \frac{10^5~L_\odot/L_\odot}{0.133~\text{K}^4/\text{K}^4}
= 7.5 \times 10^5.
$$
...
$$
\left(\frac{T_{\text{Rigel}}}{T_\odot}\right)^4
= \left(\frac{12{,}100~\text{K}}{5{,}800~\text{K}}\right)^4
= (2.086)^4
= 18.94\frac{\text{K}^4}{\text{K}^4}
= 18.94.
$$
...
$$
\left(\frac{R_{\text{Rigel}}}{R_\odot}\right)^2
= \frac{L_{\text{Rigel}}/L_\odot}{(T_{\text{Rigel}}/T_\odot)^4}
= \frac{120{,}000~L_\odot/L_\odot}{18.9~\text{K}^4/\text{K}^4}
= 6{,}350.
$$
...
$$
\left(\frac{R}{R_\odot}\right)^2
= \frac{1~L_\odot/L_\odot}{1.145~\text{K}^4/\text{K}^4}
= 0.873
\quad\Longrightarrow\quad
\boxed{R_A \approx 0.93\,R_\odot}.
$$
...
$$
\left(\frac{R}{R_\odot}\right)^2
= \frac{100~L_\odot/L_\odot}{0.0716~\text{K}^4/\text{K}^4}
= 1{,}397
\quad\Longrightarrow\quad
\boxed{R_B \approx 37\,R_\odot}.
$$
...
$$
\left(\frac{R}{R_\odot}\right)^2
= \frac{1~L_\odot/L_\odot}{18.33~\text{K}^4/\text{K}^4}
= 0.0546
\quad\Longrightarrow\quad
\boxed{R_C \approx 0.23\,R_\odot}.
$$
...
$$
\frac{R_{\text{inferred}}}{R_{\text{true}}}
= \left(\frac{T_{\text{true}}}{T_{\text{apparent}}}\right)^2
= \left(\frac{5{,}796~\text{K}}{4{,}140~\text{K}}\right)^2
...
$$
\frac{\lambda_{H\beta}}{\lambda_{H\alpha}}
= \frac{\Delta E_{H\alpha}}{\Delta E_{H\beta}}
= \frac{1.889~\text{eV}}{2.550~\text{eV}}
= 0.741\frac{\text{eV}}{\text{eV}}
= 0.741.
$$
...
**Luminosity factor:**
$$
\left(\frac{L_\star}{L_\odot}\right)^{1/4}
= \left(\frac{1.0~L_\odot}{1.0~L_\odot}\right)^{1/4}
= 1.
$$
...
**Distance factor:**
$$
\left(\frac{d}{1~\text{AU}}\right)^{-1/2}
= \left(\frac{1.5~\text{AU}}{1.0~\text{AU}}\right)^{-1/2}
= \frac{1}{\sqrt{1.5}}
= \frac{1}{1.225}
= 0.816.
$$
...
$$
\left(\frac{d}{1~\text{AU}}\right)^{-1/2}
= \left(\frac{0.72~\text{AU}}{1.0~\text{AU}}\right)^{-1/2}
= \frac{1}{\sqrt{0.72}}
= \frac{1}{0.849}
= 1.179.
$$
