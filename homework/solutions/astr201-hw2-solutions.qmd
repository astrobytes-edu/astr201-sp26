...
$$v_{\text{esc},\oplus} = \sqrt{1.25 \times 10^{12}} \approx 1.12 \times 10^6\,\text{cm/s} = 11.2\,\text{km/s}$$
...
$$v_{\text{esc,Moon}} = \sqrt{5.7 \times 10^{10}} \approx 2.4 \times 10^5\,\text{cm/s} = 2.4\,\text{km/s}$$
...
Rearranging $P^2 = 4\pi^2 a^3/(GM)$ (assuming $m_{\text{Io}} \ll M_J$):

$$M = \frac{4\pi^2 a^3}{GP^2}$$

**Steps:**

**(a) Convert period to seconds:**

$$P = 1.77\,\text{days} \times \frac{24\,\text{hr}}{1\,\text{day}} \times \frac{3600\,\text{s}}{1\,\text{hr}}$$

$$= 1.77 \times 24 \times 3600\,\text{s} = 1.77 \times 86400\,\text{s} \approx 1.53 \times 10^5\,\text{s}$$

**(b) Calculate each component:**
...
**Source:** A **hot dense object** (produces continuous spectrum) with a **cooler gas** in front of it.
...
- Wavelength: $\lambda = 600$ nm (orange light, not green as stated)
...
Also useful: $600$ nm $= 6000$ Å (since 1 nm = 10 Å)

**Answer (a):** $\boxed{\lambda = 6.0 \times 10^{-5}\,\text{cm} = 6000\,\text{Å}}$
