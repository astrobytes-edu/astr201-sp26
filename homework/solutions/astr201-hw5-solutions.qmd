...
**(a) Total mass**
$$
\frac{M_A + M_B}{M_\odot} = \frac{\left(2.00\right)^3}{\left(2.00\right)^2} = \frac{8}{4} = 2.00
$$
...
$$
\frac{M_B}{M_A} = \frac{K_A}{K_B} = \frac{40}{20} = 2.0
$$
So $M_B = 2M_A$. Then:
$$
...
$$
\boxed{\text{A 5-mag difference corresponds to a factor of }100\text{ in flux.}}
$$
...
$$
\frac{M_1+M_2}{M_\odot}=\frac{4.0^3}{4.0^2}=\frac{64}{16}=4.0
\Rightarrow
M_1+M_2=4.0\,M_\odot
$$

$$
\frac{M_2}{M_1}=\frac{K_1}{K_2}=\frac{25}{20}=1.25
$$
So $M_2=1.25M_1$ and:
$$
