...
**(a) Star A: $p=0.50''$**
$$d_A = \frac{1}{0.50\ \text{arcsec}} = 2.0\ \text{pc}.$$
$$d_A = 2.0\ \text{pc}\times 3.086\times10^{18}\ \frac{\text{cm}}{\text{pc}} = 6.17\times10^{18}\ \text{cm}.$$

**(b) Star B: $p=0.020''$**
$$d_B = \frac{1}{0.020\ \text{arcsec}} = 50\ \text{pc}.$$
$$d_B = 50\ \text{pc}\times 3.086\times10^{18}\ \frac{\text{cm}}{\text{pc}} = 1.54\times10^{20}\ \text{cm}.$$

**(c) Farther by factor**
$$\frac{d_B}{d_A} = \frac{50\ \text{pc}}{2.0\ \text{pc}} = 25.$$
...
=\left(\frac{50\ \text{pc}}{20\ \text{pc}}\right)^2
=2.5^2
=6.25.$$
...
Distance:
$$d_\star=\frac{1}{0.10\ \text{arcsec}}=10\ \text{pc}.$$
$$d_\star = 10\ \text{pc}\times 206{,}265\ \frac{\text{AU}}{\text{pc}}=2.06265\times10^6\ \text{AU}.$$

Luminosity ratio (both factors are dimensionless — flux ratio and distance ratio):
$$\frac{L_\star}{L_\odot}
=\frac{F_\star}{F_\odot}\left(\frac{d_\star}{1\ \text{AU}}\right)^2
=\left(2.0\times10^{-11}\right)\left(\frac{2.06265\times10^6\ \text{AU}}{1\ \text{AU}}\right)^2
...
Temperature:
$$T=\frac{b}{\lambda_{\text{peak}}}
=\frac{2.898\times10^6\ \text{nm}\cdot\text{K}}{725\ \text{nm}}
=3997\ \text{K}\approx4.00\times10^3\ \text{K}.$$

Compare to Sun:
$$\frac{T}{T_\odot}=\frac{3997\ \text{K}}{5800\ \text{K}}=0.689\approx0.69.$$
...
**(a) Distance**
$$d=\frac{1}{p}=\frac{1}{0.050\ \text{arcsec}}=20\ \text{pc}.$$
$$d=20\ \text{pc}\times 206{,}265\ \frac{\text{AU}}{\text{pc}}=4.1253\times10^6\ \text{AU}.$$

**(b) Luminosity ratio**

Both factors are dimensionless (flux ratio and distance ratio), so the result is a dimensionless luminosity ratio:
$$\frac{L_\star}{L_\odot}
=\frac{F_\star}{F_\odot}\left(\frac{d_\star}{1\ \text{AU}}\right)^2
=\left(1.5\times10^{-12}\right)\left(\frac{4.1253\times10^6\ \text{AU}}{1\ \text{AU}}\right)^2
=\left(1.5\times10^{-12}\right)\left(1.7018\times10^{13}\right)
\approx25.5.$$

**(c) Temperature**
$$T=\frac{b}{\lambda_{\text{peak}}}
=\frac{2.898\times10^6\ \text{nm}\cdot\text{K}}{500\ \text{nm}}
=5796\ \text{K}\approx5800\ \text{K}.$$

So
$$\frac{T}{T_\odot}\approx\frac{5796\ \text{K}}{5800\ \text{K}}\approx1.00.$$

**(d) Radius ratio**
$$\frac{R}{R_\odot}
=\left[\frac{L_\star/L_\odot}{(T/T_\odot)^4}\right]^{1/2}
=\left[\frac{25.5}{(1.00)^4}\right]^{1/2}
=\left[25.5\right]^{1/2}
\approx5.05.$$
...
For $d=1/p$ (power-law error propagation: if $d \propto p^{-1}$, then $\delta d/d = |\!-\!1|\,\delta p/p$):
$$\frac{\delta d}{d}\approx\frac{\delta p}{p}\approx6\%.$$

For $L\propto d^2$ at fixed flux (power-law propagation: exponent 2 doubles the fractional uncertainty):
$$\frac{\delta L}{L}\approx2\,\frac{\delta d}{d}\approx2\times6\%=12\%.$$
