...
\frac{L}{L_\odot}
\approx
\left(\frac{1.2\,M_\odot}{M_\odot}\right)^3
=
1.2^3
=
1.728.
...
$$
\boxed{\frac{L}{L_\odot} \approx 1.73}
$$
...
\frac{R}{R_\odot}
\approx
\left(\frac{1.2\,M_\odot}{M_\odot}\right)^{3/7}
=
1.2^{3/7}.
$$
...
$$
\boxed{\frac{R}{R_\odot} \approx 1.08}
$$
...
$$
\boxed{\frac{\bar{\rho}}{\bar{\rho}_\odot} \approx 0.95}
$$
...
\approx
\left(\frac{1.2\,M_\odot}{M_\odot}\right)\left(1.728\right)^{-1}
=
\frac{1.2}{1.728}
\approx
0.694.
...
t_{\text{MS}}
\approx
0.694\left(10~\text{Gyr}\right)
\approx
6.94~\text{Gyr}.
$$

$$
\boxed{t_{\text{MS}} \approx 6.9~\text{Gyr}}
$$
...
**Sanity check:** A star only slightly more massive than the Sun should be a little larger, somewhat brighter, and somewhat shorter lived, not wildly different in all properties. These answers match that expectation. $\checkmark$
